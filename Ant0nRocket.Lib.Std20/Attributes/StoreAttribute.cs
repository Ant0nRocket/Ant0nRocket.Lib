...
namespace Ant0nRocket.Lib.Std20.Attributes
{
    ...
    /// Only <see cref="IO.FileSystemUtils.TryReadFromFile{T}(string?, bool)"/> and
    /// <see cref="IO.FileSystemUtils.TrySaveToFile{T}(T, string?, bool?)"/> use it.
    /// </summary>
    ...
    public class StoreAttribute : Attribute
    {
        ...
        /// only when using <see cref="IO.FileSystemUtils.TrySaveToFile{T}(T, string?, bool?)"/>.
        /// </summary>
